        ...
        <section class="container-lg section-3 mt-5 pt-xl-4">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    ...
                    <img src="{{ asset('assets/home_page_images/mobile-1.png') }}" alt="mobile-img-not-show" class="">
                    </div>
                ...
                <div class="col-md-3 col-sm-6 mt-sm-0 mt-4">
                    <div class="mobile-img">
                        <img src="{{ asset('assets/home_page_images/mobile-2.png') }}" alt="mobile-img-not-show" class="">
                    </div>
                    <div class="d-flex flex-column ps-2 pe-xl-5 me-xxl-5 me-xl-4 mt-4">
                ...
                <div class="col-md-3 col-sm-6 mt-md-0 mt-4">
                    <div class="mobile-img">
                        <img src="{{ asset('assets/home_page_images/mobile-3.png') }}" alt="mobile-img-not-show" class="">
                    </div>
                    <div class="d-flex flex-column ps-2 pe-xl-5 me-xxl-5 me-xl-4 mt-4">
                ...
                <div class="col-md-3 col-sm-6 mt-md-0 mt-4">
                    <div class="mobile-img">
                        <img src="{{ asset('assets/home_page_images/mobile-4.png') }}" alt="mobile-img-not-show" class="">
                    </div>
                    <div class="d-flex flex-column ps-2 pe-xl-5 me-xxl-5 me-xl-4 mt-4">
        ...
        <div class="container-lg py-5">
            <div class="row py-5 mt-lg-2">
                ...
                <div class="col-md-6 text-center mt-md-0 mt-4">
                    <img src="{{ asset('assets/home_page_images/mobile-5.png') }}" alt="mobile-img-not-show">
                </div>
            </div>
        </div>
    </section>

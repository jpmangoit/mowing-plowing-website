             ...
             <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                 ...
                 <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    {{-- <div class="dropdown d-down-1">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark border-5 border-top border-primary bg-white"
                            aria-labelledby="dropdownMenuButton2" style="">
                            <li class="text-dark p-2">Services</li>
                            <li class="text-dark p-2">Services</li>
                            <li class="text-dark p-2">Services</li>
                            <li class="text-dark p-2">Services</li>
             ...
             <div class="col-lg-6 col-md-6 col-sm-12 col-12 p-0 bg-skyblue h-100vh ">
                 <div class="address-card">
                     <form class="theme-form login-form needs-validation" novalidate="" action=""
                         ...
                         @csrf
                         <h2>Lawn Mowing</h2>
                         <p class="mt-3 text-start">Order a Lawn Mowing service from selected area,
                             anytime. Our professional and insured fleet will cut
                             and trim your Lawn, clear off any hard surfaces and
                             send you a photo of a job well done.</p>

                         <div class="form-group mt-3">
                             <label>Address<span class="text-success"></span></label>
                             <div class="input-group"><span class="input-group-text"> <i
                                         class="fa-solid fa-location-dot"></i></span>
                                 <input class="form-control" type="text" required value="{{old('address')}}" name="address" id="location"

    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 p-0 bg-skyblue h-100vh ">
                <div class="address-card">
                    <form class="theme-form login-form needs-validation" novalidate="" action=""
                        ...
                        @csrf
                        <h2>Snow Plowing</h2>
                        <p class="mt-3 text-start">Where do you need service?</p>

                        <p class="mt-3">Choose catagory</p>

                        <div class="">
                            <a href="{{route('snow-plowing.address','home')}}" class="btn btnGray">Home</a>
                            <a href="{{route('snow-plowing.address','business')}}" class="btn btnGray">Business</a>
                            <a href="{{route('snow-plowing.address','car')}}" class="btn btnGray">Car</a>
                        </div>
                    </form>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 p-0 ">
                <img class="img-fluid h-100vh w-100" src="{{asset('assets/images/snow-1.png')}}" alt="">
            </div>

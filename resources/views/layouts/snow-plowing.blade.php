...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset( $company->favicon ?? '') }}"
        type="image/x-icon">
    <title>@yield('title') - Snow Plowing</title>

    @include('sections.snow-plowing-styles')
...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="page-body-wrapper">
            ...
            <!-- Page Sidebar Start-->
            @include('sections.snow-plowing-sidebar')
            <!-- Page Sidebar Ends-->
            <div class="page-body">
                @yield('body')
            </div>
    ...
    @include('sections.snow-plowing-footer')

    @include('sections.snow-plowing-scripts')

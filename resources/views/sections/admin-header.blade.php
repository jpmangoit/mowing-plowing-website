    ...
    <div class="header-wrapper row m-0">
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href=""><img class="img-fluid"
                        src="{{ asset( $company->logo ?? 'assets/images/logo/logo.png') }}" alt=""></a></div>
        ...
        <div class="nav-right col-10 col-sm-6 pull-right right-header p-0">
            <ul class="nav-menus">
                        ...
                        <ul class="custom-scrollbar">
                            <li>
                                <div class="media"><img class="img-fluid b-r-5 me-3 img-50"
                                        src="{{ asset('assets/images/banner-1.jpg') }}" alt="">
                            ...
                            <li>
                                <div class="media"><img class="img-fluid b-r-5 me-3 img-50"
                                        src="{{ asset('assets/images/product-4.png') }}" alt="">
                                    <div class="media-body">
                            ...
                            <li>
                                <div class="media"><img class="img-fluid b-r-5 me-3 img-50"
                                        src="{{ asset('assets/images/product-6.jpg') }}" alt="">
                                    <div class="media-body">
                ...
                {{-- <li class="onhover-dropdown">
                            ...
                            <li>
                                <div class="media">
                                    <div class="notification-img bg-light-primary"><img
                                            src="{{ asset('assets/images/avtar/man.png') }}" alt=""></div>
                                    <div class="media-body">
                            ...
                            <li>
                                <div class="media">
                                    <div class="notification-img bg-light-secondary"><img
                                            src="{{ asset('assets/images/avtar/teacher.png') }}" alt=""></div>
                                    <div class="media-body">
                            ...
                            <li>
                                <div class="media">
                                    <div class="notification-img bg-light-info"><img
                                            src="{{ asset('assets/images/avtar/teenager.png') }}" alt=""></div>
                                    <div class="media-body">
                            ...
                            <li>
                                <div class="media">
                                    <div class="notification-img bg-light-success"><img
                                            src="{{ asset('assets/images/avtar/chinese.png') }}" alt=""></div>
                                    <div class="media-body">
                 ...
                 <li>
                        <form action="{{ route('admin.order.calender') }}" method="POST">
                            @csrf
                            <button style="background-color: white; border:antiquewhite" type="submit">Calender</button>
                        </form>
                 </li>
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="{{ route('admin.edit-profile') }}"><i data-feather="user"></i><span>Account </span></a>
                        </li>
                        ...
                        <li><a href="{{route('admin.generalsettings.setting.show-setting')}}"><i data-feather="settings"></i><span>Settings</span></a>
                        </li>
                        <li>

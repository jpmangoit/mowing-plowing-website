...
<head>
    <title>Welcome to Mowing and Plowing</title>
    <style>
        body {
                    ...
                    <div class="image-wrapper">
                        ...
                        <div>
                            <div class="letterTextContainer">
                                ...
                                <p>Welcome to Mowing and Plowing! Your account has been successfully created.</p>
                                <p>You can now log in using the following credentials:</p>
                                <p>Email: {{ $email }}</p>
                                <p>Password: {{ $password }}</p>
                                <br />
                                <p>To access your account, click here: <a href="{{ $url }}">{{ $url }}</a></p>
                            </div>
                        </div>
                        <div class="image-wrapper" style="color: #13287f">
                            <h3 style="font-size: 15px !important;">Thank you for joining us!</h3>
                        </div>

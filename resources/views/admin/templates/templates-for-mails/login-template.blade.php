            ...
            <div class="modelControler">
                <div class="letter-container">
                    <div class="image-wrapper">
                        ...
                        <div>
                            <div class="titlecss" style="color: #fff; background: orange; width: 250px;" ;>
                                <h2 style="font-size: 20px !important;">Hello {{ $name }}</h2>
                            </div>
                            <div class="letterTextContainer">
                               <p>Your account has been updated by admin can you please login and check the information!</p>
                                @if(isset($email))
                                <p>Email: {{ $email }}</p>
                                @endif
                                @if(isset($password))
                                ...
                                <p>To check your account details, please log in using this link:<a href="{{ $url }}">{{ $url }}</a></p>

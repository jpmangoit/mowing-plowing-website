                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="text-center">
                                        <img src="{{ asset('assets/images/job-history.png') }}" alt="" width="120px" height="120px">
                                        <h3 class="fw-normal">John Smith</h3>
                                        <div class="mb-2">
                                        ...
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa placeat saepe sapiente officia praesentium molestiae distinctio quos fuga quaerat odio? <br> ever since the 1500s</p>
                                    </div>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <h1 class="float-end text-blue">89<span class="fw-normal">%</span></h1>
                                </div>
                                <div class="col-md-3"></div>
                            </div>
                                    ...
                                    <div class="row px-5">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="progress mt-1 rounded-pill" style="height: 11px; width: 50%;">
                                                        <div class="progress-bar rounded-pill bg-primary" role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="progress mt-1 rounded-pill" style="height: 11px; width: 50%;">
                                                        <div class="progress-bar rounded-pill bg-skyblue" role="progressbar" style="width: 30%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row px-5">
                                        <div class="col-md-5">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="progress mt-1 rounded-pill" style="height: 11px; width: 50%;">
                                                        <div class="progress-bar rounded-pill bg-green" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="progress mt-1 rounded-pill" style="height: 11px; width: 50%;">
                                                        <div class="progress-bar rounded-pill bg-muted" role="progressbar" style="width: 70%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            @if ($type == 'proposals')
                <div class="row">
                    <div class="col-md-12 d-flex justify-content-center">
                        <button type="button" class="btn btn-green py-2 me-5 px-4">Accept</button>
                        <button type="button" class="btn btn-danger py-2 ms-5">Decline</button>
                    </div>
                </div>
            @endif
        </div>

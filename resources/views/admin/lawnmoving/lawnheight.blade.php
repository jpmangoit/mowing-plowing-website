            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive">
                 ...
                 <button data-bs-toggle='modal' data-bs-target='#modal-opener' data-url="{{ route('admin.generalsettings.lawnmoving.add-lawn-height') }}" style="font-size:12px; float: right">Add <i class="fa fa-plus"></i></button>
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Name</th>
...
<script>
    ...
    var table = $('#server-side-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{route('admin.generalsettings.lawnmoving.get-lawn-height-data') }}",
        columns: [
            {data: 'id', name: 'id'},
            {data: 'name', name: 'name'},

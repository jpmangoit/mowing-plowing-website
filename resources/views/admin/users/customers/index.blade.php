...
@section('body')
    ...
    <div class="container-fluid user-card">
        <div class="d-flex justify-content-between mb-3">
            <a href="{{ route('admin.users.add_new_customer') }}">
                <button class="btn btn-pill btn-success" type="button">Add New Customer</button>
            </a>
            <a href="{{ route('admin.users.customers.export') }}">
                <button class="btn btn-pill btn-primary" type="button">
                    <i data-feather="download"></i> Export Customers
                </button>
            </a>
        </div>
        <div class="row">
    ...
    <script>
        $(function() {
            ...
            $('#server-side-datatable').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('admin.users.customers.data') }}",
                "columns": [{
                        data: 'id'
                    },
                    {
                 ...
                 columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            let active = "{{ route('admin.users.customers.send_semail', ['__id__']) }}"
                                .replace('__id__', full.id)
                            ...
                            let masquerade = 
                                "{{ route('admin.users.customers.masquerade', ['__id__']) }}"
                                .replace('__id__', full.id)
                            ...
                            return (
                                ...
                                'SendEmail</a>' +
                                "<a href=" + masquerade + " class='dropdown-item'>" +
